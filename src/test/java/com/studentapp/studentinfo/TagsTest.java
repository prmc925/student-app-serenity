...
public class TagsTest extends TestBase {
    ...
    @Title("This test will verify if status code is returned for Get request")
    @Test
    ...
    @Title("This test will provide an error code 400 when user tries to access invalid resource")
    @Test
